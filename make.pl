...
sub compile {
	...
	src/res.cpp src/lxlogic.c src/mslogic.c src/unslist.cpp src/messages.cpp src/help.cpp
	src/score.cpp src/random.c src/settings.cpp src/fileio.cpp src/err.cpp src/tile.c
